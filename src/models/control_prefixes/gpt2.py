...
class GPT2ControlPrefixesWithLMHeadModel(GPT2PreTrainedModel, CustomSavePreTrainedModel):
    ...
    def __init__(self, config, pretrained_model=None):
        ...
        num_input_dep_prefixes = len(config.input_dep_prefixes.keys())
        self.prefix_len = config.prefix_len + config.control_prefix_len * num_input_dep_prefixes
        self.prefix_encoder = ControlPrefixEncoder(config)
